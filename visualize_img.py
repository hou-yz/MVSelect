...
if __name__ == '__main__':
    ...
    # imgs, tgt, keep_cams = dataset[0]
    imgs = denorm(imgs)
    # imgs[1] = set_border(imgs[1])  # , fill=(255, 192, 0)
    # imgs[10] = set_border(imgs[10])  # , fill=(0, 176, 80)
    imgs[0] = set_border(imgs[0], width=20)  # , fill=(255, 192, 0)
    imgs[2] = set_border(imgs[2], width=20)  # , fill=(0, 176, 80)
